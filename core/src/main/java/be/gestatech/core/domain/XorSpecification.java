...
public class XorSpecification<T> extends AbstractSpecification<T> {
    ...
    public XorSpecification(final Specification<T> specification1, final Specification<T> specification2) {
    ...
    public boolean isSatisfiedBy(final T object) {
        return (this.specification1.isSatisfiedBy(object) && !this.specification2.isSatisfiedBy(object))
                || (!this.specification1.isSatisfiedBy(object) && this.specification2.isSatisfiedBy(object));
    }
}
